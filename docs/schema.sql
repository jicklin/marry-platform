...
--      (create_by / update_by 为 BIGINT, 存储 SysUser.id; NULL 表示无创建者,
--      0 表示系统账号, 由 SecurityUtil.SYSTEM_USER_ID 哨兵值标识)
...
VALUES (1, 0, '0/', '总公司', 'root', 0, 1, 0, NULL, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;

-- 7.2 角色
INSERT INTO sys_role (id, name, code, data_scope, status, del_flag, create_by, create_time) VALUES
    (1, '超级管理员', 'admin', 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (2, '普通用户',   'common', 5, 1, 0, NULL, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO sys_user (id, username, password, nick_name, email, status, dept_id, del_flag, create_by, create_time) VALUES
    (1, 'admin', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2',
        '超级管理员', 'admin@marry.com', 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (2, 'demo',  '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2',
        '演示账号',    '',                  1, 1, 0, NULL, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO sys_menu (id, parent_id, name, menu_type, path, component, perm, icon, order_num, visible, status, is_cache, is_frame, del_flag, create_by, create_time) VALUES
    -- 顶层目录
    (1,   0, '系统管理', 'M', 'system',  null,          '',                'SettingsOutline',   1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (40,  0, '系统监控', 'M', 'monitor',  null,          '',                'PulseOutline',      2, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (70,  0, '系统工具', 'M', 'tool',     null,          '',                'BuildOutline',      3, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 用户管理
    (2,   1, '用户管理', 'C', 'user',     'system/user/index',     'system:user:list',   'PersonOutline',      1, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (20,  2, '用户查询', 'F', null, null,  'system:user:query',    '',                    1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (21,  2, '用户新增', 'F', null, null,  'system:user:add',      '#',                   2, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (22,  2, '用户修改', 'F', null, null,  'system:user:edit',     '#',                   3, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (23,  2, '用户删除', 'F', null, null,  'system:user:remove',   '#',                   4, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (24,  2, '重置密码', 'F', null, null,  'system:user:resetPwd', '#',                   5, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 角色管理
    (3,   1, '角色管理', 'C', 'role',     'system/role/index',     'system:role:list',   'PeopleCircleOutline',2, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (30,  3, '角色查询', 'F', null, null,  'system:role:query',    '#',                   1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (31,  3, '角色新增', 'F', null, null,  'system:role:add',      '#',                   2, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (32,  3, '角色修改', 'F', null, null,  'system:role:edit',     '#',                   3, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (33,  3, '角色删除', 'F', null, null,  'system:role:remove',   '#',                   4, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 菜单管理
    (4,   1, '菜单管理', 'C', 'menu',     'system/menu/index',     'system:menu:list',   'MenuOutline',        3, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (41,  4, '菜单查询', 'F', null, null,  'system:menu:query',    '#',                   1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (42,  4, '菜单新增', 'F', null, null,  'system:menu:add',      '#',                   2, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (43,  4, '菜单修改', 'F', null, null,  'system:menu:edit',     '#',                   3, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (44,  4, '菜单删除', 'F', null, null,  'system:menu:remove',   '#',                   4, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 部门管理
    (5,   1, '部门管理', 'C', 'dept',     'system/dept/index',     'system:dept:list',   'BusinessOutline',    4, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (50,  5, '部门查询', 'F', null, null,  'system:dept:query',    '#',                   1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (51,  5, '部门新增', 'F', null, null,  'system:dept:add',      '#',                   2, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (52,  5, '部门修改', 'F', null, null,  'system:dept:edit',     '#',                   3, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (53,  5, '部门删除', 'F', null, null,  'system:dept:remove',   '#',                   4, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 字典管理
    (6,   1, '字典管理', 'C', 'dict',     'system/dict/index',     'system:dict:list',   'BookOutline',        6, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (60,  6, '字典查询', 'F', null, null,  'system:dict:query',    '#',                   1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (61,  6, '字典新增', 'F', null, null,  'system:dict:add',      '#',                   2, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (62,  6, '字典修改', 'F', null, null,  'system:dict:edit',     '#',                   3, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (63,  6, '字典删除', 'F', null, null,  'system:dict:remove',   '#',                   4, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 参数设置
    (7,   1, '参数设置', 'C', 'config',   'system/config/index',   'system:config:list', 'OptionsOutline',     7, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (70,  7, '参数新增', 'F', null, null,  'system:config:add',    '#',                   1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (71,  7, '参数修改', 'F', null, null,  'system:config:edit',   '#',                   2, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    (72,  7, '参数删除', 'F', null, null,  'system:config:remove', '#',                   3, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 操作日志
    (410, 40, '操作日志', 'C', 'operlog',  'monitor/operlog/index', 'monitor:operlog:list',  'ListOutline',  1, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (411, 410,'日志删除', 'F', null, null, 'monitor:operlog:remove','#',                    1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 登录日志
    (420, 40, '登录日志', 'C', 'loginlog', 'monitor/loginlog/index','monitor:loginlog:list','LogInOutline', 2, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (421, 420,'日志删除', 'F', null, null, 'monitor:loginlog:remove','#',                   1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 在线用户
    (430, 40, '在线用户', 'C', 'online',   'monitor/online/index',  'monitor:online:list', 'GlobeOutline',      3, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    (431, 430,'强制下线', 'F', null, null, 'monitor:online:forceLogout','#',                1, 1, 1, 0, 1, 0, NULL, CURRENT_TIMESTAMP),
    -- 代码生成
    (700, 70, '代码生成', 'C', 'gen',      'tool/gen/index',        'tool:gen:list',       'CodeSlashOutline',  1, 1, 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
...
VALUES (1, '用户性别', 'sys_user_sex', 1, 0, NULL, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;

INSERT INTO sys_dict_data (dict_type, label, value, is_default, order_num, status, del_flag, create_by, create_time) VALUES
    ('sys_user_sex', '男',   '1', 1, 1, 1, 0, NULL, CURRENT_TIMESTAMP),
    ('sys_user_sex', '女',   '2', 0, 2, 1, 0, NULL, CURRENT_TIMESTAMP),
    ('sys_user_sex', '未知', '0', 0, 3, 1, 0, NULL, CURRENT_TIMESTAMP)
ON CONFLICT DO NOTHING;


-- 7.8 欢迎公告
INSERT INTO sys_notice (id, title, type, content, status, del_flag, create_by, create_time)
VALUES (1, '欢迎使用 marry-platform', 'notice', '这是 marry-platform 多模块 RBAC 平台的初始通知。', 1, 0, NULL, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
